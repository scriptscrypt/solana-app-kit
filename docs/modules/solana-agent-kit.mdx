...
<Card>
  <CardHeader>
    <CardTitle>🤖 AI-Powered Blockchain Interactions</CardTitle>
  </CardHeader>
  <CardContent>
    Revolutionary chat interface that transforms complex blockchain operations into simple conversations, powered by advanced AI models and the Solana Agent Kit
  </CardContent>
</Card>
...
<Accordion>
  <AccordionItem title="Transaction Operations">
  ...
  <AccordionItem title="DeFi Operations">
  ...
  <AccordionItem title="Portfolio Management">
...
<Accordion>
  <AccordionItem title="Chat Persistence">
  ...
  <AccordionItem title="Message Management">
  ...
  <AccordionItem title="User Management">
