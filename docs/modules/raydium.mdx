...
<Card>
  <CardHeader>
    <CardTitle>🌊 Professional Token Launching</CardTitle>
  </CardHeader>
  <CardContent>
    Launch tokens with advanced configurations including bonding curves, vesting schedules, and pool migration options on Solana's premier DEX
  </CardContent>
</Card>
...
<Accordion>
  <AccordionItem title="Token Launching">
  ...
  <AccordionItem title="Token Swapping">
...
<Accordion>
  <AccordionItem title="Validation Functions">
  ...
  <AccordionItem title="Calculation Functions">
  ...
  <AccordionItem title="Constants & Options">
