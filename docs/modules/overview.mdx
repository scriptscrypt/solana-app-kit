...
<Card>
  <CardHeader>
    <CardTitle>🧩 Modular by Design</CardTitle>
  </CardHeader>
  <CardContent>
    Every protocol integration is self-contained with its own components, hooks, services, and types. Pick and choose what you need for your app.
  </CardContent>
</Card>
