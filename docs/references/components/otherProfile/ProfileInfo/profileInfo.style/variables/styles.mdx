...
Defined in: [src/components/otherProfile/ProfileInfo/profileInfo.style.ts:4](https://github.com/SendArcade/solana-app-kit/blob/bd4b3556b8f469c27ebb06f4df65b3a36b43ba3b/src/components/otherProfile/ProfileInfo/profileInfo.style.ts#L4)
