...
[solana-app-kit](../../../../../README.mdx) / [components/otherProfile/ProfileInfo/profileInfo.style](../README.mdx) / styles

# Variable: styles

> `const` **styles**: `object`

Defined in: [src/components/otherProfile/ProfileInfo/profileInfo.style.ts:4](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/otherProfile/ProfileInfo/profileInfo.style.ts#L4)
