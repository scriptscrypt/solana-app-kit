...
[solana-app-kit](../../../../../README.mdx) / [components/otherProfile/perksCard/perksCard.style](../README.mdx) / styles

# Variable: styles

> `const` **styles**: `object`

Defined in: [src/components/otherProfile/perksCard/perksCard.style.ts:4](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/otherProfile/perksCard/perksCard.style.ts#L4)
