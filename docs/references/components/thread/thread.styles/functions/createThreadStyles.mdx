...
[solana-app-kit](../../../../README.mdx) / [components/thread/thread.styles](../README.mdx) / createThreadStyles

# Function: createThreadStyles()

> **createThreadStyles**(`theme`, `overrideStyles`?, `userStyleSheet`?): `object`

Defined in: [src/components/thread/thread.styles.ts:14](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/thread/thread.styles.ts#L14)
