...
[solana-app-kit](../../../../README.mdx) / [components/thread/thread.theme](../README.mdx) / THREAD\_DEFAULT\_THEME

# Variable: THREAD\_DEFAULT\_THEME

> `const` **THREAD\_DEFAULT\_THEME**: `object`

Defined in: [src/components/thread/thread.theme.ts:1](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/thread/thread.theme.ts#L1)
