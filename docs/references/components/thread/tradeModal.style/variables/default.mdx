...
[solana-app-kit](../../../../README.mdx) / [components/thread/tradeModal.style](../README.mdx) / default

# Variable: default

> **default**: `object`

Defined in: [src/components/thread/tradeModal.style.ts:3](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/thread/tradeModal.style.ts#L3)
