...
[solana-app-kit](../../../../README.mdx) / [components/thread/ThreadAncestors](../README.mdx) / default

# Function: default()

> **default**(`__namedParameters`): `null` \| `Element`

Defined in: [src/components/thread/ThreadAncestors.tsx:48](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/thread/ThreadAncestors.tsx#L48)
