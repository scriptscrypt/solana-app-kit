...
[solana-app-kit](../../../../README.mdx) / [components/thread/tokenModal.style](../README.mdx) / default

# Variable: default

> **default**: `object`

Defined in: [src/components/thread/tokenModal.style.ts:3](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/thread/tokenModal.style.ts#L3)
