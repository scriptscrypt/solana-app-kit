...
[solana-app-kit](../../../../../README.mdx) / [components/thread/sections/SectionNftListing](../README.mdx) / default

# Function: default()

> **default**(`__namedParameters`): `Element`

Defined in: [src/components/thread/sections/SectionNftListing.tsx:49](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/thread/sections/SectionNftListing.tsx#L49)
