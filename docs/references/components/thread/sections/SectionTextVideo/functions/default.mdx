...
[solana-app-kit](../../../../../README.mdx) / [components/thread/sections/SectionTextVideo](../README.mdx) / default

# Function: default()

> **default**(`__namedParameters`): `Element`

Defined in: [src/components/thread/sections/SectionTextVideo.tsx:41](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/thread/sections/SectionTextVideo.tsx#L41)
