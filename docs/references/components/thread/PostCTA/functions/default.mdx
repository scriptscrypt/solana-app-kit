...
[solana-app-kit](../../../../README.mdx) / [components/thread/PostCTA](../README.mdx) / default

# Function: default()

> **default**(`__namedParameters`): `null` \| `Element`

Defined in: [src/components/thread/PostCTA.tsx:109](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/thread/PostCTA.tsx#L109)
