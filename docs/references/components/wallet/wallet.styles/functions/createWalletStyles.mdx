...
[solana-app-kit](../../../../README.mdx) / [components/wallet/wallet.styles](../README.mdx) / createWalletStyles

# Function: createWalletStyles()

> **createWalletStyles**(`theme`, `overrideStyles`?, `userStyleSheet`?): `object`

Defined in: [src/components/wallet/wallet.styles.ts:63](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/wallet/wallet.styles.ts#L63)
