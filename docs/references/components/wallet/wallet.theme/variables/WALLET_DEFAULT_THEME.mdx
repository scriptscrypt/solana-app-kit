...
[solana-app-kit](../../../../README.mdx) / [components/wallet/wallet.theme](../README.mdx) / WALLET\_DEFAULT\_THEME

# Variable: WALLET\_DEFAULT\_THEME

> `const` **WALLET\_DEFAULT\_THEME**: `object`

Defined in: [src/components/wallet/wallet.theme.ts:28](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/wallet/wallet.theme.ts#L28)
