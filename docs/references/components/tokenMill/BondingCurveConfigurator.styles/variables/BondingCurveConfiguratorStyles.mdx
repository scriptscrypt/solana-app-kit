...
[solana-app-kit](../../../../README.mdx) / [components/tokenMill/BondingCurveConfigurator.styles](../README.mdx) / BondingCurveConfiguratorStyles

# Variable: BondingCurveConfiguratorStyles

> `const` **BondingCurveConfiguratorStyles**: `object`

Defined in: [src/components/tokenMill/BondingCurveConfigurator.styles.ts:31](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/tokenMill/BondingCurveConfigurator.styles.ts#L31)
