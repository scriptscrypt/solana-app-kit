...
[solana-app-kit](../../../../README.mdx) / [components/pumpfun/PumpfunSellSection](../README.mdx) / PumpfunSellSection

# Function: PumpfunSellSection()

> **PumpfunSellSection**(`props`, `deprecatedLegacyContext`?): `ReactNode`

Defined in: [src/components/pumpfun/PumpfunSellSection.tsx:78](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/pumpfun/PumpfunSellSection.tsx#L78)
