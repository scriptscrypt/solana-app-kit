...
[solana-app-kit](../../../../README.mdx) / [components/pumpfun/Pumpfun.styles](../README.mdx) / PumpfunBuyStyles

# Variable: PumpfunBuyStyles

> `const` **PumpfunBuyStyles**: `object`

Defined in: [src/components/pumpfun/Pumpfun.styles.ts:3](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/pumpfun/Pumpfun.styles.ts#L3)
