...
[solana-app-kit](../../../../README.mdx) / [components/pumpfun/PumpfunLaunchSection](../README.mdx) / PumpfunLaunchSection

# Function: PumpfunLaunchSection()

> **PumpfunLaunchSection**(`props`, `deprecatedLegacyContext`?): `ReactNode`

Defined in: [src/components/pumpfun/PumpfunLaunchSection.tsx:64](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/pumpfun/PumpfunLaunchSection.tsx#L64)
