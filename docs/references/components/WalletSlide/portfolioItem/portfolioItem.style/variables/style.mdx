...
[solana-app-kit](../../../../../README.mdx) / [components/WalletSlide/portfolioItem/portfolioItem.style](../README.mdx) / style

# Variable: style

> `const` **style**: `object`

Defined in: [src/components/WalletSlide/portfolioItem/portfolioItem.style.ts:3](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/WalletSlide/portfolioItem/portfolioItem.style.ts#L3)
