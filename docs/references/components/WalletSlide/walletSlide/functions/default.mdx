...
[solana-app-kit](../../../../README.mdx) / [components/WalletSlide/walletSlide](../README.mdx) / default

# Function: default()

> **default**(): `Element`

Defined in: [src/components/WalletSlide/walletSlide.tsx:30](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/WalletSlide/walletSlide.tsx#L30)
