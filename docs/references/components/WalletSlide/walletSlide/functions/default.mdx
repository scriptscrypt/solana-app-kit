...
Defined in: [src/components/WalletSlide/walletSlide.tsx:30](https://github.com/SendArcade/solana-social-starter/blob/bd4b3556b8f469c27ebb06f4df65b3a36b43ba3b/src/components/WalletSlide/walletSlide.tsx#L30)
