...
[solana-app-kit](../../../../README.mdx) / [components/userListing/userListing.style](../README.mdx) / styles

# Variable: styles

> `const` **styles**: `object`

Defined in: [src/components/userListing/userListing.style.ts:3](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/userListing/userListing.style.ts#L3)
