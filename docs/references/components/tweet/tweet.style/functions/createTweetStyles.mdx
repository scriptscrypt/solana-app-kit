...
[solana-app-kit](../../../../README.mdx) / [components/tweet/tweet.style](../README.mdx) / createTweetStyles

# Function: createTweetStyles()

> **createTweetStyles**(`isSmallScreen`): `object`

Defined in: [src/components/tweet/tweet.style.ts:4](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/tweet/tweet.style.ts#L4)
