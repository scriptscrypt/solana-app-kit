...
[solana-app-kit](../../../../README.mdx) / [components/slider/slider](../README.mdx) / default

# Function: default()

> **default**(`props`): `ReactNode`

Defined in: [src/components/slider/slider.tsx:49](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/slider/slider.tsx#L49)
