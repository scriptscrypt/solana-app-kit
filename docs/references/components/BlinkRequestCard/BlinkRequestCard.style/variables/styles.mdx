...
[solana-app-kit](../../../../README.mdx) / [components/BlinkRequestCard/BlinkRequestCard.style](../README.mdx) / styles

# Variable: styles

> `const` **styles**: `object`

Defined in: [src/components/BlinkRequestCard/BlinkRequestCard.style.ts:3](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/BlinkRequestCard/BlinkRequestCard.style.ts#L3)
