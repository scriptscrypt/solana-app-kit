...
Defined in: [src/components/suggestionsCard/suggestionsCard.style.ts:3](https://github.com/SendArcade/solana-social-starter/blob/bd4b3556b8f469c27ebb06f4df65b3a36b43ba3b/src/components/suggestionsCard/suggestionsCard.style.ts#L3)
