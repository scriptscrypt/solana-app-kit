...
[solana-app-kit](../../../../README.mdx) / [components/topNavigation/topNavigation](../README.mdx) / TopNavigation

# Function: TopNavigation()

> **TopNavigation**(`props`, `deprecatedLegacyContext`?): `ReactNode`

Defined in: [src/components/topNavigation/topNavigation.tsx:40](https://github.com/SendArcade/solana-social-starter/blob/b27156124ee1831d644b1af765e8d55a2885cd4f/src/components/topNavigation/topNavigation.tsx#L40)
