...
> **usePrivyWalletLogic**(): { user: null | PrivyUser; isReady: boolean; solanaWallet: EmbeddedSolanaWalletState; handlePrivyLogin: (options: LoginOptions) => Promise<void>; handlePrivyLogout: (setStatusMessage?: (msg: string) => void) => Promise<void>; monitorSolanaWallet: (options: MonitorOptions) => Promise<void>; handleWalletRecovery: (options: RecoveryOptions) => Promise<void> }
