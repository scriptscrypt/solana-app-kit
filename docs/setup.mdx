...
<Card>
  <CardHeader>
    <CardTitle>⚡ Quick Setup Promise</CardTitle>
  </CardHeader>
  <CardContent>
    Get your Solana mobile app running in under 5 minutes with our automated setup process
  </CardContent>
</Card>
...
<Tabs>
  ...
  <Tab title="Android Development">
    <CardGroup cols={1}>
      ...
      <Card title="Java Development Kit (JDK)" icon="coffee">
...
<Accordion>
  <AccordionItem title="🔧 Core Environment Variables">
    ```env
...
<Accordion>
  <AccordionItem title="🗄️ Required Server Environment Variables">
    ```env
    # Blockchain
...
<Accordion>
  <AccordionItem title="🔧 Enabling Dev Mode">
  ...
  <AccordionItem title="🛠️ Dev Mode Features">
    - **Mock wallet connections** for testing without real wallets
    - **Sample data** for UI development and testing
    - **Network request logging** for debugging API calls
    - **State inspection tools** for Redux state debugging
  </AccordionItem>
</Accordion>
...
<Card>
  ...
  <CardContent>
    You now have a fully functional Solana mobile app running. Continue to the [Project Structure](/docs/structure/repo) guide to understand how everything works together.
  </CardContent>
</Card>