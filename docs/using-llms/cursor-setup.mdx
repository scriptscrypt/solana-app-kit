...
![Using Local Docs MCP in Cursor](docs/assets/using-llms/cursormcp.png)
...
When running the command, you'll need to provide:
- External Admin Key
- Assistant API Key

These API keys can be found in your Mintlify Dashboard under Settings > API Keys.
...
- **Documentation Search**: Query across all Solana App Kit documentation
- **API Integration**: Access to documented API endpoints
- **Context-Aware Responses**: Get relevant code examples and documentation snippets
