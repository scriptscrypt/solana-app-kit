...
<Card>
  <CardHeader>
    <CardTitle>🏗️ Well-Architected Codebase</CardTitle>
  </CardHeader>
  <CardContent>
    The Solana App Kit follows a modular, scalable architecture that separates concerns while maintaining clean integration points between different features and protocols
  </CardContent>
</Card>
...
<Accordion>
  <AccordionItem title="🔧 Adding New Features">
  ...
  <AccordionItem title="🎨 UI Changes">
  ...
  <AccordionItem title="📱 New Screens">
  ...
  <AccordionItem title="🏪 State Changes">
