...
```bash
yarn add solana-social-starter
# or
npm install solana-social-starter
```
...
import { CustomizationProvider } from 'solana-social-starter';
...
```javascript
import { Thread } from 'solana-social-starter';
...
```javascript
import { pumpfunService, PumpfunScreen, NftScreen } from 'solana-social-starter';
...
import { authReducer, threadReducer, transactionReducer } from 'solana-social-starter';
