...
description: "Defined in: [src/components/thread/thread.types.ts:67](https://github.com/SendArcade/solana-social-starter/blob/03568260ca96ed63f77049843c721de1cb011893/src/components/thread/thread.types.ts#L67)"
---
