...
<Card>
  <CardHeader>
    <CardTitle>🚀 From Idea to App Store in Minutes</CardTitle>
  </CardHeader>
  <CardContent>
    Build production-ready Solana mobile applications with 10+ protocol integrations, enterprise-grade wallets, and AI-powered features
  </CardContent>
</Card>
...
<Accordion>
  <AccordionItem title="🏦 DeFi Trading Apps">
  ...
  <AccordionItem title="🚀 Meme Token Platforms">
  ...
  <AccordionItem title="💬 Social Trading Apps">
  ...
  <AccordionItem title="🎨 NFT Marketplaces">
  ...
  <AccordionItem title="👛 Wallet Applications">
  ...
  <AccordionItem title="🤖 AI-Powered Apps">
  ...
  <AccordionItem title="💳 Payment Apps">
...
<Card>
  <CardHeader>
    <CardTitle>Built with ❤️ for the Solana ecosystem</CardTitle>
  </CardHeader>
  <CardContent>
    **Created by SendAI and Send Arcade** - Empowering developers to build the future of mobile-first Web3 applications
  </CardContent>
</Card>