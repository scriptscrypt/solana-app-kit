...
import { ClientRaydiumService, TokenMetadata, LaunchpadConfigData, LaunchpadOptions, LaunchpadResult } from './clientRaydiumService';
...
export { LaunchpadConfigData, LaunchpadOptions, LaunchpadResult };

/**
 * RaydiumService - A client-side service for interacting with Raydium DEX
 */
export class RaydiumService {
  ...
  /**
   * Create and launch a token on Raydium
   * 
   * @param tokenData Token metadata including name, symbol, description etc.
   * @param configData Configuration for the token launch
   * @param userPublicKey User's wallet public key
   * @param sendTransaction Function to send the transaction
   * @param options Additional options
   * @returns Promise with the result of the token creation
   */
  static async createAndLaunchToken(
    ...
    return ClientRaydiumService.createAndLaunchToken(
      tokenData,
      configData,
      userPublicKey,
      sendTransaction,
